          ...
          <div className='max-w-[768px] w-full px-4'>
            {currentMessages.length === 0 ? (
              <div className='flex items-center justify-center h-full'>
                <h1 className='text-3xl text-gray-600 font-light'>有什麼我可以幫你的嗎？</h1>
              </div>
            ) : (
        ...
        <div className='max-w-[768px] mx-auto p-4'>
          <div className='relative'>
            <input
              ...
              disabled={isLoading}
              className='w-full px-4 py-3 bg-white border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500 text-gray-900 placeholder-gray-500 disabled:opacity-50 shadow-sm'
            />
            <button
              onClick={handleSubmit}
              disabled={inputValue.trim() === '' || isLoading}
              className='absolute right-3 top-1/2 -translate-y-1/2 p-1 rounded-lg hover:bg-gray-100 disabled:opacity-50 disabled:cursor-not-allowed text-gray-600'
            >
              {isLoading ? (
